    ...
    <div class="current-weather-card">
        ...
        <div class="weather-details">
            <div class="detail-card">
                ...
                <div class="detail-value">{feels_like}<span class="detail-unit">°C</span></div>
            </div>
            <div class="detail-card">
            ...
            <div class="detail-card">
                ...
                <div class="detail-value">{wind_speed}<span class="detail-unit"> m/s</span></div>
            </div>
            <div class="detail-card">
            ...
            <div class="detail-card">
                ...
                <div class="detail-value">{visibility:.1f}<span class="detail-unit"> km</span></div>
            </div>
            <div class="detail-card">
                <div class="detail-title">Sunrise</div>
                <div class="detail-value" style="font-size: 1.4rem;">{sunrise}</div>
            </div>
            <div class="detail-card">
                <div class="detail-title">Sunset</div>
                <div class="detail-value" style="font-size: 1.4rem;">{sunset}</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
